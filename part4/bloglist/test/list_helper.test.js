...
describe("favorite blog", () => {
  ...
  test("return the blog with most likes in an array", () => {
  ...
  test("return the blog with most likes in an array of one blog", () => {
  ...
  test("return message for empty array", () => {
    const result = listHelper.favoriteBlog([]);

    assert.strictEqual(result, "Please pass an array of blogs");
  });

  test("return message for no array", () => {
    const result = listHelper.favoriteBlog(0);
